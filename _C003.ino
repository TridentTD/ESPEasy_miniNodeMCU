//#######################################################################################################
//########################### Controller Plugin 003: OpenHAB MQTT #######################################
//#######################################################################################################

#define CPLUGIN_003
#define CPLUGIN_ID_003         3
#define CPLUGIN_NAME_003       "OpenHAB MQTT"
...
boolean CPlugin_003(byte function, struct EventStruct *event, String& string)
{
  ...
  switch (function)
  {
    ...
    case CPLUGIN_PROTOCOL_TEMPLATE:
      {
        strcpy_P(Settings.MQTTsubscribe, PSTR("/%nodename%/#"));                 //PSTR("/%sysname%/#"));
        strcpy_P(Settings.MQTTpublish, PSTR("/%nodename%/%devicename%/%valname%")); //PSTR("/%sysname%/%tskname%/%valname%"));
        break;
      }
