...
#define DEFAULT_AP_KEY      "mininodemcu"         // Enter network WPA key for AP (config) mode
...
#define DEFAULT_MQTT_PUB    "sensors/%nodename%/%devicename%/%valname%" //"sensors/espeasy/%sysname%/%tskname%/%valname%" // Enter your pub
#define DEFAULT_MQTT_SUB    "sensors/%nodename%/#"   //"sensors/espeasy/%sysname%/#" // Enter your sub
